// 变体 A — 卡片网格：三个大卡片，每个都有渐变背景和图标
// 手机端 3 个垂直排列的卡片，每个卡片占据足够高度方便手指点击
...
export default function HomeVariantA() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-indigo-50 to-white px-5 py-10 flex flex-col">
      {/* PWA 安装引导条 */}
      {showPwaBanner && (
        <div className="mb-6 bg-indigo-600 text-white rounded-2xl px-4 py-3 flex items-center gap-3 shadow-lg shadow-indigo-200">
          ...
          <button
            ...
            className="w-6 h-6 rounded-full bg-white/20 flex items-center justify-center text-xs flex-shrink-0 active:bg-white/30 transition-colors"
          >
            ✕
          </button>
        </div>
